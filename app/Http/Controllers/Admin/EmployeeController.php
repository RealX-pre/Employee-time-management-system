...
class EmployeeController extends Controller
{
    ...
    public function create() {
        $data = [
            ...
            'desgs' => ['Гүйцэтгэх захирал', 'Ахлах нягтлан бодогч', 'Нягтлан бодогч ', 'Борлуулалтын менежер',
            'Оффис менежер','Дотоод үйл ажиллагаа хариуцсан дарга','Хүний нөөцийн албаны дарга','ТУЗ-ын гишүүн']
        ];
