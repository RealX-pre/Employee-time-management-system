...
class EmployeeController extends Controller
{
    ...
    public function profile_edit($employee_id) {
        $data = [
            ...
            'desgs' => ['Захиргаа', 'Олон улсын харилцааны тэнхим', 'Мэдээлэл, компьютерийн ухааны тэнхим', 'Байгалийн ухааны салбар','Нягтлан бодох бүртгэлийн тэнхим','Маркетинг худалдааны тэнхим','Нийтийн эрх зүйн тэнхим']
        ];
