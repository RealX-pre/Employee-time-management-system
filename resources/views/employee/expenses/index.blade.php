...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Хүсэлтийн жагсаалт</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-8 mx-auto">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Нийт хүсэлтийн жагсаалт</h3>
                        </div>
                        <div class="card-body">
                            @if ($expenses->count())
                            <table class="table table-hover" id="dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Шалтгаан</th>
                                        <th>Статус</th>
                                        <th>Нийт хэмжээ (төг)</th>
                                        <th class="none">Тайлбар</th>
                                        <th class="none">Зарлагын хуулга</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('employee.expenses.edit', $expense->id) }}" class="btn btn-flat btn-warning">Засах</a>
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-body text-center">
                                                    <img src="/storage/app/public/receipts/{{ $expenses->get($i-1)->receipt }}" class="img-fluid" alt="Receipt Image" style="width: auto; height:100%">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
