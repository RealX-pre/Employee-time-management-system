...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Ирц бүртгүүлэх</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Өнөөдрийн цаг бүртгэл</h3>
                        </div>
                        <!-- /.card-header -->
                        ...
                        @endif
                            ...
                            <div class="card-body">
                                ...
                                <div class="row text-center">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="entry_time">Бүртгүүлэх цаг</label>
                                            <input
                                            type="text"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="entry_location">Бүртгүүлэх байршил</label>
                                            <input
                                            type="text"
                                            class="form-control text-center"
                                            id="entry_loc"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="entry_ip">Бүртгүүлэх IP хаяг</label>
                                            <input
                                            type="text"
                                            class="form-control text-center"
                                            id="entry_ip"
                                ...
                                <div class="row text-center">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="exit_time">Гарах цаг</label>
                                            <input
                                            type="text"
                                            class="form-control text-center"
                                            name="exit_time"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exit_location">Гарах байршил</label>
                                            <input
                                            type="text"
                                            class="form-control text-center"
                                            id="exit_loc"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="exit_ip">Гарах IP хаяг</label>
                                            <input
                                            type="text"
                                            class="form-control text-center"
                                            id="exit_ip"
