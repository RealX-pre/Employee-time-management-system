...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Чөлөөний жагсаалт</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-lg-8 col-md-10 mx-auto">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Нийт чөлөөний  жагсаалт</h3>
                        </div>
                        <div class="card-body">
                            @if ($leaves->count())
                            <table class="table table-hover" id="dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Шалтгаан</th>
                                        <th>Статус</th>
                                        <th class="none">Хагас өдөр</th>
                                        <th class="none">Эхлэх хугацаа</th>
                                        <th class="none">Дуусах хугацаа</th>
                                    ...
                                    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="card card-info">
                                                <div class="card-header">
                                                    <h5 style="text-align: center !important">Чөлөөний статус засварлах</h5>
                                                </div>
                                                <form
                            ...
                            <div class="alert alert-info text-center" style="width:50%; margin: 0 auto">
                                <h4>Чөлөөний хүсэлт байхгүй байна</h4>
                            </div>
                            @endif
                        </div>
                    </div>
